...
# WindowManagers
WindowManagers="Awesome Enlightenment Fluxbox Openbox Windowmaker Xmonad"
...
LongWMs[5]="Window manager that emulates the NeXT user interface"
LongWMs[6]="Tiling window manager for X"
# Taskbars (Docks & Panels)
Taskbars="cairo-dock docky fbpanel tint2"
LongBars[1]="Customizable dock & launcher application"
LongBars[2]="Full fledged dock application"
LongBars[3]="Lightweight NETWM compliant desktop panel"
LongBars[4]="Simple and light panel/taskbar"
